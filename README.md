...
git checkout -b topic_branch origin/zmod_adc_dac/master
```
...
You must also copy and remane the system.bit and system.dtb files to: zm-adc-dac.bit and zm-adc-dac.dtb.
...
For more information on the ZmodADC1410, please visit its [Zmod ADC Resource Center](https://reference.digilentinc.com/reference/zmod/zmodadc/start) on the Digilent Wiki.
