...
The first assumes that you are using our prepared ~~[image with Debian 9 rootfs]()~~, in this case you only need to replace the files in the **boot partition** of the SD card with the files located in *\<repo-location\>/images/linux/*.
